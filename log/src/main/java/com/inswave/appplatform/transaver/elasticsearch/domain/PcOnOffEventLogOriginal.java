...
@Getter 
@Setter
public class PcOnOffEventLogOriginal extends Document {
    ...
    @Field(type = FieldType.Nested, name = "pcOnOffEventLogData")
    private List<PcOnOffEventLogData> pcOnOffEventLogData;
