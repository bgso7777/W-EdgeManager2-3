...
@Getter 
@Setter
public class ClientPerformanceResourceLogOriginal extends Document {
    ...
    @Field(type = FieldType.Nested, name = "clientPerfResourceData")
    private List<ClientPerformanceResourceLogData> clientPerfResourceData;
