...
@Getter 
@Setter
public class DeviceErrorLogOriginal extends Document {
    ...
    @Field(type = FieldType.Nested, name = "deviceDriverErrorData")
    private List<DeviceErrorLogData> deviceDriverErrorData;
