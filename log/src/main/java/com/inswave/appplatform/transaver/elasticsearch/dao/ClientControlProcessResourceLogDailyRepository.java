...
public interface ClientControlProcessResourceLogDailyRepository extends ElasticsearchRepository<ClientControlProcessResourceLogDaily, String>, Document2Repository<ClientControlProcessResourceLogDaily> {

    List<ClientControlProcessResourceLogDaily> findByTimeCurrentGreaterThanAndTimeCurrentLessThan(String from, String to);
