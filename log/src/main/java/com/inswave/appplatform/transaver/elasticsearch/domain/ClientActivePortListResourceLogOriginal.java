...
@Getter 
@Setter
public class ClientActivePortListResourceLogOriginal extends Document {
    ...
    @Field(type = FieldType.Nested, name = "clientActivePortListResourceData")
    private List<ClientActivePortListResourceLogData> clientActivePortListResourceData;
