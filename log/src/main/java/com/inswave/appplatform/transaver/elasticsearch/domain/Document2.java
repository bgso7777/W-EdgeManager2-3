...
/**
 *   Current Daily Log의 Document에서 extends함.
 */
@Getter
@Setter
public abstract class Document2 {
    ...
    // 통계 기준 값
    @Field(type = FieldType.Keyword, name = "statisticsValue")
    ...
    public static Map<String, Object> getAsMap(Document2 document2) {
        ...
        return objectMapper.convertValue(document2, new TypeReference<Map<String, Object>>() {
        });
    }
