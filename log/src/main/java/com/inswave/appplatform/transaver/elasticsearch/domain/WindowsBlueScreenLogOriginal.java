...
@Getter 
@Setter
public class WindowsBlueScreenLogOriginal extends Document {
    ...
    @Field(type = FieldType.Nested, name = "blueScreenData")
    private List<WindowsBlueScreenLogData> blueScreenData;
