...
public interface ClientProgramListResourceLogDailyRepository extends ElasticsearchRepository<ClientProgramListResourceLogDaily, String>, Document2Repository<ClientProgramListResourceLogDaily> {

    List<ClientProgramListResourceLogDaily> findByTimeCurrentGreaterThanAndTimeCurrentLessThan(String from, String to);
