...
@Getter 
@Setter
public class ClientControlProcessResourceLogOriginal extends Document {
    ...
    @Field(type = FieldType.Nested, name = "clientControlProcessResourceData")
    private List<ClientControlProcessResourceLogData> clientControlProcessResourceData;
