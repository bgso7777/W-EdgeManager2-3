...
@Getter
@Setter
public class ClientWindowsUpdateListResourceLogOriginal extends Document {
    ...
    @Field(type = FieldType.Nested, name = "clientWindowsUpdateListResourceData")
    private List<ClientWindowsUpdateListResourceLogData> clientWindowsUpdateListResourceData;
}