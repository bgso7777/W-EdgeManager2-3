...
@Getter
@Setter
public class ClientProcessCreationLogOriginal extends Document {
    ...
    @Field(type = FieldType.Nested, name = "processCreationLogData")
    private List<ClientProcessCreationLogData> processCreationLogData;
