...
public interface ClientWindowsUpdateListResourceLogDailyRepository extends ElasticsearchRepository<ClientWindowsUpdateListResourceLogDaily, String>, Document2Repository<ClientWindowsUpdateListResourceLogDaily> {

    List<ClientWindowsUpdateListResourceLogDaily> findByTimeCurrentGreaterThanAndTimeCurrentLessThan(String from, String to);
