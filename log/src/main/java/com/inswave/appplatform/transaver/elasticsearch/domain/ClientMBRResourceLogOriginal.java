...
@Getter
@Setter
public class ClientMBRResourceLogOriginal extends Document {
    ...
    @Field(type = FieldType.Nested, name = "clientMBRResourceData")
    private List<ClientMBRResourceLogData> clientMBRResourceData;
}