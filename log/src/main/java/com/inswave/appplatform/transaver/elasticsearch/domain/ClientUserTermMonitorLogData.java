...
@Getter 
@Setter
public class ClientUserTermMonitorLogData {
    /*
" {
    ""channel"": ""Application"",
    ""level"": 2,
    ...
    ""processId"": 1152,
    ""properties"": """",
    ""providerId"": ""d3cb85d1-d61c-4bcf-9674-7910ee54d6af"",
    ""providerName"": ""DPTF"",
    ""qualifiers"": null,
    ""recordId"": 34178,
    ""relatedActivityId"": """",
    ...
    @Field(type = FieldType.Keyword, name = "userEventID")
    private String userEventID;

    @Field(type = FieldType.Keyword, name = "userEventData")
    private String userEventData;

    @Field(type = FieldType.Date, name = "timeCreated", format = DateFormat.custom, pattern = Constants.TAG_DATE_PATTERN_YYYY_MM_DD_T_HH_MM_SS_SSS_Z)
