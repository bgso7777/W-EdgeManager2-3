...
@Getter
@Setter
public class ClientProgramListResourceLogOriginal extends Document {
    ...
    @Field(type = FieldType.Nested, name = "clientProgramListResourceData")
    private List<ClientProgramListResourceLogData> clientProgramListResourceData;
