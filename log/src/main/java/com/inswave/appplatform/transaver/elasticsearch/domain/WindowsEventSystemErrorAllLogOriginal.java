...
@Getter 
@Setter
public class WindowsEventSystemErrorAllLogOriginal extends Document {
    ...
    @Field(type = FieldType.Nested, name = "collectWindowsEventLogData")
    private List<WindowsEventSystemErrorAllLogData> collectWindowsEventLogData;
