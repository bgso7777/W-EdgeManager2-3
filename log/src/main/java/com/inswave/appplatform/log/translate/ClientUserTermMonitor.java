...
@Service
public class ClientUserTermMonitor {

	public ClientUserTermMonitor () {
	}

	public ClientUserTermMonitorLogOriginal getOriginalObject(StringBuffer message) {
		ClientUserTermMonitorLogOriginal clientUserTermMonitorLogOriginal = null;
		return clientUserTermMonitorLogOriginal;
	}

	public ClientUserTermMonitorLogOriginal getOriginalObject(LinkedHashMap linkedHashMap) throws JsonProcessingException, Exception {
		return LogDataObjectMapper.getObjectMapper().convertValue(linkedHashMap, ClientUserTermMonitorLogOriginal.class);
	}


	private List<ClientUserTermMonitorLogStatistics> reconstructMinutelyDocument(ClientUserTermMonitorLogOriginal windowsEventSystemErrorAllLogOriginal) {

		List<ClientUserTermMonitorLogStatistics> windowsEventSystemErrorAllLogMinutelies = new ArrayList<ClientUserTermMonitorLogStatistics>();

		for( ClientUserTermMonitorLogData collectWindowsEventLogData: windowsEventSystemErrorAllLogOriginal.getUserTermMonitorLogData() ) {

			ClientUserTermMonitorLogStatistics windowsEventSystemErrorAllLogMinutely = new ClientUserTermMonitorLogStatistics();
	...
	public List<ClientUserTermMonitorLogDaily> reconstructDailyDocument(ClientUserTermMonitorLogOriginal windowsEventSystemErrorAllLogOriginal) {

		List<ClientUserTermMonitorLogDaily> windowsEventSystemErrorAllLogDailies = new ArrayList<ClientUserTermMonitorLogDaily>();

		for( ClientUserTermMonitorLogData collectWindowsEventLogData: windowsEventSystemErrorAllLogOriginal.getUserTermMonitorLogData() ) {

			ClientUserTermMonitorLogDaily windowsEventSystemErrorAllLogDaily = new ClientUserTermMonitorLogDaily();
			...
			windowsEventSystemErrorAllLogDaily.setUserEventID(collectWindowsEventLogData.getUserEventID());
			windowsEventSystemErrorAllLogDaily.setUserEventData(collectWindowsEventLogData.getUserEventData());
	...
	public List<ClientUserTermMonitorLog> reconstructDocument(ClientUserTermMonitorLogOriginal windowsEventSystemErrorAllLogOriginal) {

		List<ClientUserTermMonitorLog> windowsEventSystemErrorAllLogs = new ArrayList<ClientUserTermMonitorLog>();

		for( ClientUserTermMonitorLogData collectWindowsEventLogData: windowsEventSystemErrorAllLogOriginal.getUserTermMonitorLogData() ) {

			ClientUserTermMonitorLog windowsEventSystemErrorAllLog = new ClientUserTermMonitorLog();
			...
			windowsEventSystemErrorAllLog.setUserEventID(collectWindowsEventLogData.getUserEventID());
			windowsEventSystemErrorAllLog.setUserEventData(collectWindowsEventLogData.getUserEventData());
